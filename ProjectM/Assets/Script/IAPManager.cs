...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public static string PunchOfGems = "coinspunch420";
    public static string BucketOfGems = "gemsbucket1000";
    public static string GemsChest = "gemschest1500";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(PunchOfGems, ProductType.Consumable);
        builder.AddProduct(BucketOfGems, ProductType.Consumable);
    ...
    {
        BuyProductID(PunchOfGems);
    }
    public void BuyGemsBucket()
    {
        BuyProductID(BucketOfGems);
    }
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, PunchOfGems, StringComparison.Ordinal))
        {
        ...
        else if (String.Equals(args.purchasedProduct.definition.id, BucketOfGems, StringComparison.Ordinal))
        {
